    ...
    <div className="flex items-center justify-center h-screen bg-cyan-800 text-white">
      <div className="w-full max-w-md p-8  bg-cyan-800 rounded-xl shadow-xl shadow-slate-950">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-indigo-700 hover:bg-indigo-600 text-white font-medium py-2 px-4 rounded-md focus:outline-none focus:ring focus:ring-indigo-200 focus:ring-opacity-50 p-2 disabled:bg-gray-400" disabled={loading}>Register</button>
        </form>
        <p className="text-sm text-white p-1">Already an User ? <Link href="/account/login" className="text-violet-400  transition duration-300 ease-in-out">Login</Link></p>
