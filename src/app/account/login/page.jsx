        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full border-gray-300 bg-cyan-800 border-2  rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 p-2"
          ...
          <p className="text-sm text-gray-600 p-2">
            <Link href="/account/reset-password-link" className="text-white  transition duration-300 ease-in-out">Forgot Password ?</Link>
          </p>
          <button
            type="submit"
